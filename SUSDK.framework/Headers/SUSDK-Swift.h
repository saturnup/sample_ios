...
@interface NSNumber (SWIFT_EXTENSION(SUSDK))
@end
...
SWIFT_CLASS("_TtC5SUSDK19SUSDKViewController")
@interface SUSDKViewController : UIViewController <UIViewControllerTransitioningDelegate>
- (void)viewDidLoad;
...
@interface UIColor (SWIFT_EXTENSION(SUSDK))
...
@interface UIView (SWIFT_EXTENSION(SUSDK))
@end
